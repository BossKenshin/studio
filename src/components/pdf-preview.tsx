  ...
  return (
    <Card className="h-full shadow-lg">
      ...
      <CardContent className="h-[calc(100%-4rem)] overflow-y-auto p-2 md:p-4">
        <div id="pdf-preview-content" className="bg-white text-black p-8 rounded shadow-md min-h-[29.7cm] w-[21cm] max-w-full mx-auto print:shadow-none print:p-0">
          {/* Manual Title */}
          ...
          {data.steps.map((step, index) => (
            <div key={step.id || index} className="mb-8 p-6 border border-gray-200 rounded-lg shadow-sm bg-gray-50/50 break-inside-avoid">
          ...
          {data.steps.length === 0 && (
             <div className="text-center text-gray-500 py-10">
                <p>Add steps to your manual using the form.</p>
             </div>
          )}
        </div>
      </CardContent>
